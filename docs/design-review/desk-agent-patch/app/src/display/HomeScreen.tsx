...
export function HomeScreen({
  ...
  // Never surface the raw "unavailable"/"—" wire sentinel (which also
  // truncated mid-word in the narrow tile) -- show a clean "Idle" instead.
  const trackLabel = hasActiveTrack(stats.nowPlaying) ? stats.nowPlaying : 'Idle';
