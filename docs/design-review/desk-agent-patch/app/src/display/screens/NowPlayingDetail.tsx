  ...
  return (
    <View style={styles.screen}>
      ...
      {hasTrack ? (
        ...
        // Honest, composed empty state -- centred rather than top-aligned in a
        // void, and never the raw "unavailable" sentinel from the wire.
...
const styles = StyleSheet.create({
  ...
  // Fills the space below the header and vertically centres the empty state so
  // it doesn't float at the top of a large black void.
  emptyBody: {
    flex: 1,
    alignItems: 'center',
